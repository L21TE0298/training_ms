...
INSERT INTO Reward (idProduct, goalPoints, description) VALUES
(1, 100, 'Whey Protein Isolate - High-quality protein for muscle growth and recovery.'),
(2, 200, 'Creatine Monohydrate - Boosts strength and performance.'),
(3, 300, 'BCAA 2:1:1 - Essential amino acids for muscle repair.'),
(4, 400, 'Pre-Workout - Enhances energy and focus for intense workouts.'),
(5, 500, 'Fish Oil - Supports heart health and reduces inflammation.'),
(6, 600, 'Multivitamin - Comprehensive daily nutrition support.'),
(7, 700, 'Glutamine - Aids in muscle recovery and immune function.'),
(8, 800, 'Caffeine Pills - Increases alertness and energy levels.'),
(9, 900, 'Green Tea Extract - Rich in antioxidants and promotes fat loss.'),
(10, 1000, 'Beta-Alanine - Improves endurance and reduces fatigue.'),
(11, 1100, 'Mass Gainer - High-calorie formula for muscle mass gain.'),
(12, 1200, 'Casein Protein - Slow-digesting protein for overnight recovery.'),
(13, 1300, 'L-Carnitine - Supports fat metabolism and energy production.'),
(14, 1400, 'Nitric Oxide Booster - Enhances blood flow and muscle pumps.'),
(15, 1500, 'Electrolyte Powder - Replenishes essential minerals lost during exercise.'),
(16, 1600, 'ZMA - Zinc, magnesium, and vitamin B6 for muscle recovery.'),
(17, 1700, 'CLA - Conjugated linoleic acid for fat loss and lean muscle.'),
(18, 1800, 'Ashwagandha - Adaptogen that reduces stress and boosts energy.'),
(19, 1900, 'Turmeric Curcumin - Anti-inflammatory and antioxidant benefits.'),
(20, 2000, 'Beet Root Powder - Enhances endurance and cardiovascular health.');
